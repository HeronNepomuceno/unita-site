	...
	const services = [
		{
			...
			description: 'Realce sua beleza natural com procedimentos seguros e eficazes',
			icon: '✨'
		},
		{
			title: 'Tratamentos Corporais',
			description: 'Cuide do seu corpo com tecnologias avançadas',
			icon: '💆'
		},
		{
			title: 'Skincare Premium',
			description: 'Protocolos personalizados para sua pele',
			icon: '🌸'
		},
		{
			title: 'Bem-estar Integral',
			description: 'Equilíbrio entre corpo, mente e espírito',
			icon: '🧘'
		},
		{
			title: 'Bem-estar Integral',
...
<div class="page">
	...
	<section id="sobre" class="about">
		<div class="about-content">
			...
			<p class="about-text">
				Somos uma clínica dedicada à estética integrativa, combinando tecnologia de ponta com
	...
	<section id="galeria" class="gallery">
		<div class="section-header">
			...
			<p class="section-subtitle">Confira alguns dos nossos trabalhos</p>
		</div>
