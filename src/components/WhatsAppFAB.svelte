<script lang="ts">
	export let phone: string = '5586998678703';
	export let message: string = 'Olá, gostaria de marcar uma consulta!';
</script>

<!-- WhatsApp Floating Action Button -->
<a href="https://wa.me/{phone}?text={encodeURIComponent(message)}" target="_blank" class="whatsapp-fab" aria-label="Converse conosco no WhatsApp">
