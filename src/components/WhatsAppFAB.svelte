...
<a href="https://wa.me/5586998678703?text={encodeURIComponent("Olá, gostaria de agendar uma consulta!")}" target="_blank" class="whatsapp-fab" aria-label="Converse conosco no WhatsApp">
